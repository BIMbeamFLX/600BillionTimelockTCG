...
work, `MINT_WRITE_RATE_MAX` (20 a minute, every POST) and `MINT_QUOTE_RATE_MAX` (60 a
minute, quote/reveal/eligibility/LNURL callback); see `docs/deploy.md` §5. The finding as
first written:
